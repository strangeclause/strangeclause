      ...
      <nav className="fixed left-0 right-0 top-0 z-50 border-b border-white/[0.045] bg-[#020202]/72 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-4 px-6 py-5 sm:px-12 md:px-20 lg:px-28 xl:px-36">
          ...
          <div className="flex min-w-0 flex-col items-center text-center">
            ...
            <p className="hidden max-w-[280px] truncate text-[8px] lowercase tracking-[0.12em] text-[#666666] sm:block">
              quiet music
            </p>
          </div>
          ...
          <button
            ...
            className="group flex items-center gap-2 rounded-full border border-white/[0.045] bg-white/[0.016] px-3.5 py-1.5 text-[8px] uppercase tracking-[0.22em] text-[#777777] shadow-[0_10px_30px_rgba(0,0,0,0.45)] transition-all duration-700 hover:-translate-y-0.5 hover:border-white/10 hover:bg-white/[0.03] hover:text-white/75 sm:px-4 sm:py-2 sm:text-[8.5px]"
          >
            <Plus
              size={11}
              strokeWidth={1.5}
